...
<head>
  ...
  <style>
    ...
    .hero {
      background: url('/images/dashboard-bg.jpg') no-repeat center center;
  ...
  <div class="container">
    ...
    <form action="student/register" method="post">
      <div class="form-group">
        ...
        <input type="text" id="register_fullName" name="fullName" value="${param.fullName}" required>
      </div>
      <div class="form-group">
        <label for="register_email">Email:</label>
        <input type="email" id="register_email" name="email" value="${param.email}" required>
      </div>
      <div class="form-group">
        <label for="register_address">Address:</label>
        <input type="text" id="register_address" name="address" value="${param.address}" required>
      </div>
      <div class="form-group">
        <label for="register_phoneNumber">Phone Number:</label>
        <input type="text" id="register_phoneNumber" name="phoneNumber" value="${param.phoneNumber}" required>
      </div>
      <div class="form-group">
        <label for="register_age">Age:</label>
        <input type="number" id="register_age" name="age" value="${param.age}" required>
      </div>
      <div class="form-group">
        <label for="register_username">Username:</label>
        <input type="text" id="register_username" name="username" value="${param.username}" required>
      </div>
      <div class="form-group">
